...
@pro_aws_provider(api=_B,name=_D)
def lambda_legacy():from localstack.services.lambda_ import lambda_starter as A;from localstack_ext.services.lambda_.legacy.lambda_extended import LambdaExtLifecycleHook as B,LambdaService as C,patch_lambda as D;D();return C(_B,start=A.start_lambda,stop=A.stop_lambda,check=A.check_lambda,lifecycle_hook=B())
@pro_aws_provider(api=_B,name=_C)
def lambda_v1():from localstack.services.lambda_ import lambda_starter as A;from localstack_ext.services.lambda_.legacy.lambda_extended import LambdaExtLifecycleHook as B,LambdaService as C,patch_lambda as D;D();return C(_B,start=A.start_lambda,stop=A.stop_lambda,check=A.check_lambda,lifecycle_hook=B())
...
@pro_aws_provider(api=_B,name=_F)
...
@pro_aws_provider()
def s3():from localstack_ext.services.s3.provider import S3ProviderPro as A;B=A();return Service.for_provider(B,dispatch_table_factory=MotoFallbackDispatcher)
...
@pro_aws_provider(api=_A,name=_D)
def s3_legacy():from localstack.services.s3.legacy import s3_listener as B,s3_starter as A;from localstack_ext.services.s3 import s3_extended as C;C.patch_s3();return Service(_A,listener=B.UPDATE_S3,start=A.start_s3,check=A.check_s3,lifecycle_hook=A.S3LifecycleHook())
@pro_aws_provider(api=_A,name=_C)
def s3_v1():from localstack.services.s3.legacy import s3_listener as B,s3_starter as A;from localstack_ext.services.s3 import s3_extended as C;C.patch_s3();return Service(_A,listener=B.UPDATE_S3,start=A.start_s3,check=A.check_s3,lifecycle_hook=A.S3LifecycleHook())
@pro_aws_provider()
