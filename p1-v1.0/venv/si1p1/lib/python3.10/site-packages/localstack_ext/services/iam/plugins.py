...
@hooks.on_infra_start(should_load=config_ext.ACTIVATE_PRO)
def add_policy_generation_routes():from localstack.services.edge import ROUTER as A;from localstack_ext.services.iam.policy_generation.router import IAMPolicyGenerationRouter as B;B(A).register_routes()
