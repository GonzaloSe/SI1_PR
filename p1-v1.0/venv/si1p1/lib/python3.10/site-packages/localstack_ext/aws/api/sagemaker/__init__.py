...
class SagemakerApi:
    ...
    def create_auto_ml_job(
        ...
        CreateAutoMLJobV2 <https://docs.aws.amazon.com/sagemaker/latest/dg/autopilot-automate-model-development-create-experiment-api.html#autopilot-create-experiment-api-migrate-v1-v2>`__.
