...
# feature flag for the new Cloud Pod client (switching to 1 by default with 2.3; delete old client with 3.0)
ACTIVATE_NEW_POD_CLIENT = localstack_config.is_env_not_false("ACTIVATE_NEW_POD_CLIENT")
